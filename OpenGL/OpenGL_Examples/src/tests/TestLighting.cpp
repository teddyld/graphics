...
namespace test {
	TestLighting::TestLighting()
		: m_AmbientStrength(0.1f), m_SpecularStrength(0.5f), m_Shininess(32)
	{
		float vertices[] = {
	...
	void TestLighting::OnRender()
	{
		...
		glm::vec3 lightPosition(sin(glfwGetTime()), 1.0f, 2.0f);
		...
		m_ObjectShader->SetUniform3f("u_ObjectColor", 1.0f, 0.5f, 0.31f);
