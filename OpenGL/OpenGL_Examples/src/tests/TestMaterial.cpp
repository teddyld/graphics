...
namespace test {
	...
	void TestMaterial::OnRender()
	{
		...
		m_MaterialShader->SetUniformMat4f("u_Model", objectModel);
		m_MaterialShader->SetUniformMat4f("u_View", m_View);
		...
		m_MaterialShader->SetUniform3f("u_Light.position", lightPosition.x, lightPosition.y, lightPosition.z);
		m_MaterialShader->SetUniform3f("u_Light.ambient", 0.2f, 0.2f, 0.2f);
		m_MaterialShader->SetUniform3f("u_Light.diffuse", 0.5f, 0.5f, 0.5f);
		m_MaterialShader->SetUniform3f("u_Light.specular", 1.0f, 1.0f, 1.0f);

		renderer.Draw(*m_ObjectVAO, *m_MaterialShader, 36);
